        ...
        try:
            for f_val in folios_a_usar:
                ...
                for est in estampados_unicos:
                    # Filtra el nombre para quitar "(2)", "(3)" etc. para el cliente
                    est_visual = est.split(' (')[0] if ' (' in est else est
                    
                    elementos_codigos.append(Paragraph(f"MODELO: {modelo} &nbsp;&nbsp;&nbsp;&nbsp; ESTAMPADO: {est_visual}", style_bc_title))
